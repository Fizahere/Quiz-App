...
const prevQuiz = questionSection.querySelector(".previous-question");
...
const showQuestion = () => {
  ...
  prevQuiz.style.display = questionIndex > 0 ? "block" : "none";
...
! - Previous Quiz Button Chage function
*/
const prevQuizBtnChange = () => {
  console.log("working");
  prevQuiz.style.display = "block";
